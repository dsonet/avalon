...
//本模块提供的Promise完整实现ECMA262v6 的Promise规范
    ...
    var setImmediate = typeof golbal.setImmediate === "function" ? function(fn) {
        golbal.setImmediate(fn)
    } : function(fn) {
        golbal.setTimeout(fn, 0)
    }
    ...
    var nativePromise = golbal.Promise
	...
	golbal.Promise.prototype.done = function(onSuccess) {//添加与jQuery相仿的API
			return this.then(onSuccess)
	}
	golbal.Promise.prototype.fail = function(onFail) {//添加与jQuery相仿的API
		return this.then(null, onFail)
	}
